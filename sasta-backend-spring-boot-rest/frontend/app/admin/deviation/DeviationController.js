	    ...
	    $scope.gridOptions = {
			columns: [
				...
				{ field: "vpName", locked: true, groupable:true,width: '130px', title:'Panchayat'},
				{
					...
					columns :[
						{ field: "jcMisusedByOthersCount",headerTemplate: "No", title : "Job cards misused by others No",width: '130px', groupable:false },
						{ field: "jcMisusedByOthersAmt",format: '{0:n0}', headerTemplate : "Amount", title : "Job cards misused by others Amount",width: '130px', groupable:false },
					]
				},
				{
					title : "Wages paid to workers without job cards",
					columns :[
						{ field: "wagesPaidWorkersWithoutJcCount",headerTemplate: "No", title : "Wages paid to workers without job cards No",width: '130px', groupable:false },
						{ field: "wagesPaidWorkersWithoutJcAmt",format: '{0:n0}', headerTemplate : "Amount", title : "Wages paid to workers without job cards Amount",width: '130px', groupable:false },
					]
				},
				{
					title : "Wages paid without recording measurements",
					columns :[
						{ field: "wagesPaidWithoutRecordMesurementCount",headerTemplate: "No", title : "Wages paid without recording measurements No",width: '130px', groupable:false },
						{ field: "wagesPaidWithoutRecordMesurementAmt",format: '{0:n0}', headerTemplate : "Amount", title : "Wages paid without recording measurements Amount",width: '130px', groupable:false },
					]
				},
				{
					title : "Wages paid in excess of M-Book value",
					columns :[
						{ field: "wagesPaidExcessMBooksValueCount",headerTemplate: "No", title : "Wages paid in excess of M-Book value No",width: '130px', groupable:false },
						{ field: "wagesPaidExcessMBooksValueAmt",format: '{0:n0}', headerTemplate : "Amount", title : "Wages paid in excess of M-Book value Amount",width: '130px', groupable:false },
					]
				},
				{
					title : "Variations in signatures between NMR & Register I",
					columns :[
						{ field: "variationsBetweenNMRRegisterCount",headerTemplate: "No", title : "Variations in signatures between NMR & Register I No",width: '130px', groupable:false },
						{ field: "variationsBetweenNMRRegisterAmt",format: '{0:n0}', headerTemplate : "Amount", title : "Variations in signatures between NMR & Register I Amount",width: '130px', groupable:false },
					]
				},
				{
				...
				},
				{
					...
					columns :[
						...
						{ field: "inEligibleWorkersIncludeUnder18Amt",format: '{0:n0}', headerTemplate : "Amount", title : "Ineligible workers including under 18 years Amount",width: '130px', groupable:false },
					]
				},
				{
					title : "Difference between online NMR & physical NMR",
					columns :[
						{ field: "diffOnlineNMRPhysicalNMRCount",headerTemplate: "No", title : "Difference between online NMR & physical NMR No",width: '130px', groupable:false },
						{ field: "diffOnlineNMRPhysicalNMRAmt",format: '{0:n0}', headerTemplate : "Amount", title : "Difference between online NMR & physical NMR Amount",width: '130px', groupable:false },
					]
				},
				{
