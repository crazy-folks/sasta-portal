app.controller('EntityGroupsController',['$http','$window','$scope','$rootScope','notify','$location','$state','storage','entitygroupsfactory','exDialog',
	function($http,$window,$scope,$rootScope,notify,$location,$state,storage,entitygroupsfactory,exDialog){
	    ...
	    $scope.AddDialog = function (id) {
	        ...
	        exDialog.openPrime({
	            scope: $scope,
	            template: 'admin/entitygroups/add.html',
	    ...
	    $scope.EditData = function(data){
	        ...
	        exDialog.openPrime({
	            scope: $scope,
	            template: 'admin/entitygroups/edit.html',
	            controller: 'EntityGroupsController',
	            width: '600px',
	            animation: true,
	            grayBackground: true            
