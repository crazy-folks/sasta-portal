	...
	function($http,$window,$scope,$rootScope,notify,$location,$state,storage,grievancefactory){
	    ...
	    $scope.gridOptions = {
	        columns: [ 
		        		...
		        		{ field: "reqForConstructionCattleShelter", width:"130px", title:'Request for the Construction of Cattle shelter'},
		        		{ field: "demandForWork", width:"130px", title:'Demand for work'},
		        		{ field: "demandForRenewelJc", width:"130px", title:'Demand for Renewal of Job card'},
		        		{ field: "demandForIndividualBenefitScheme", width:"130px", title : "Demand for individual benefit schemes"},
		        		{ field: "demandForWagesIncrease", width:"130px", title : "Demand for Wage increase"},
		        		{ field: "demandForPds", width:"130px", title : "Demand for PDS"},
		        		{ field: "demandForLibraryBuilding", width:"130px", title:'Demand for Library Building'},
		        		{ field: "nonProvisionOfWorkSiteFacilities", width:"130px", title:'Non provision of work site facilities'},
		        		{ field: "complaintAgainstBankingCorrespondent", width:"130px", title:'Complaint against Banking correspondent'},
		        		{ field: "oapnotProvidedJc", width:"130px", title : "OAP not provided job card"},
		        		{ field: "oapnotProvidedWork", width:"130px", title : "OAP not provided work"},
		        		{ field: "complaintsAgainstWorksiteFacilidator", width:"130px", title : "Complaints against worksite facilitator"},	

		        		{ field: "complaintsAgainstVPPresident", width:"130px", title:'Complaints against VP president'},
		        		{ field: "complaintsAgainstUnionOverseer", width:"130px", title:'Complaints against Union overseer'},
		        		{ field: "complaintsAgainstBDOVP", width:"130px", title:'Complaint against BDO VP'},
		        		{ field: "complaintsAgainstVPSecretory", width:"130px", title : "Complaint against VP Secretary"},
		        		{ field: "others", width:"130px", title : "Others"},
		        		{ field: "delayWagesPaymentCount", width:"130px", title : "Delay in wage payment No"},
		        		{ field: "delayWagesPaymentAmt", width:"130px", title:'Delay in wage payment Amount'},
		        		{ field: "fullEntitlementNotGivenCount", width:"130px", title:'Full Entitlement Not Given To Differently Abled No'},
		        		{ field: "fullEntitlementNotGivenAmt", width:"130px", title:'Full Entitlement Not Given To Differently Abled Amount'},
		        		{ field: "lessPaymentValueRecordedMBookCount", width:"130px", title : "Less Payment Than Value Recorded In M Book No"},
		        		{ field: "lessPaymentValueRecordedMBookAmt", width:"130px", title : "Less Payment Than Value Recorded In M Book Amount"},
		        		{ field: "wagesDrawnLessThanActualNoDaysCount", width:"130px", title : "Wages Drawn For Days Less Than Actual No Of Days Worked No"},			        		
		        		
		        		{ field: "wagesDrawnLessThanActualNoDaysAmt", width:"130px", title:'Wages Drawn For Days Less Than Actual No Of Days Worked Amount'},
		        		{ field: "wagesNotPaidWorkersActuallyWorkedCount", width:"130px", title:'Wages Not Paid Yo Workers Who Actually Worked No'},
		        		{ field: "wagesNotPaidWorkersActuallyWorkedAmt", width:"130px", title:'Wages Not Paid Yo Workers Who Actually Worked Amount'},
		        		{ field: "transportAllowanceNotGivenCount", width:"130px", title : "Transport Allowance Not Given No"},
		        		{ field: "transportAllowanceNotGivenAmt", width:"130px", title : "Transport Allowance Not Given Amount"},
		        		{ field: "noCompensationDeadAtWorksiteCount", width:"130px", title : "No Compensation For Injured At Worksite No"},
		        		{ field: "noCompensationInjuredAtWorksiteAmt", width:"130px", title:'No Compensation For Injured At Worksite Amount'},
		        		{ field: "noCompensationInjuredAtWorksiteCount", width:"130px", title:'No Compensation For Death At Worksite No'},
		        		{ field: "noCompensationDeadAtWorksiteAmt", width:"130px", title:'No Compensation For Death At Worksite Amount'},
		        		{ field: "reqPaymentCompletedIHHLWorkCount", width:"130px", title : "Request For The Payment Of Completed IHHL Work No"},
		        		{ field: "reqPaymentCompletedIHHLWorkAmt", width:"130px", title : "No Request For The Payment Of Completed IHHL Work Amount"},
		        		{
 							title : "",
		                    width: '30px',
