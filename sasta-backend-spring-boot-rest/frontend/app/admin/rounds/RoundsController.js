	...
	function($http,$window,$scope,$rootScope,notify,$location,$state,storage,roundsfactory){
	    ...
	    $scope.gridOptions = {
	        columns: [ 
		        		...
		        		{ field: "startDate", title : "Start Date", editable : false, template: "#= kendo.toString(kendo.parseDate(new Date(startDate), 'yyyy-MM-dd'), 'dd/MM/yyyy') #" },
		        		{ field: "endDate", title : "End Date", editable : false, template: "#= kendo.toString(kendo.parseDate(new Date(endDate), 'yyyy-MM-dd'), 'dd/MM/yyyy') #" },
