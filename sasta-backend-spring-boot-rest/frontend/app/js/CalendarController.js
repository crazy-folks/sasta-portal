app.controller('PublicCalendarController',['$http','$window','$scope','$rootScope','notify','$location','$state','storage','calendarfactory',
    function($http,$window,$scope,$rootScope,notify,$location,$state,storage,calendarfactory){
        ...
        $scope.GetCalenders = function(){
            var response = calendarfactory.GetSastaCalender();
...
app.factory('calendarfactory',function($http,$q,$rootScope){
