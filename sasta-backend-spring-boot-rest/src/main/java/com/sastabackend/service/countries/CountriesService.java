...
public interface CountriesService {
    ResponseModel Add(String country_name, String country_description, String country_code,
                      String country_short_name, Long country_create_by);
    ResponseModel Update(Integer country_id,String country_name,String country_description,String country_code,
